...
public class FetchStudentListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (StudentEntity student : results) {
            ...
            responseText.append("<td><a href=\"./fill-input?id="+ student.getId()+"&nume="+student.getNume()+"&prenume="+
                    student.getPrenume()+"&varsta="+student.getVarsta()+"\">Actualizare</a><br/>");
            responseText.append("<a href=\"./delete-student?id="+ student.getId()+"\">Stergere</a></td></tr>\"");
        }
