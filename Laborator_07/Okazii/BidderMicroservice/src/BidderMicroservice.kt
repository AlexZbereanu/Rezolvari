...
class BidderMicroservice(name:String, email:String, telephone:String) {
    ...
    init {
        try {
            ...
            myIdentity = "[$name:$email:$telephone]"
    ...
    private fun bid() {
        ...
        val biddingMessage = Message.create(myIdentity, "${auctioneerSocket.localAddress}:${auctioneerSocket.localPort}",
            "licitez:$pret")
...
fun main(args: Array<String>) {
    val bidderMicroservice = BidderMicroservice(args[0], args[1], args[2])
