        ...
        val receiveInQueueSubscription = receiveInQueueObservable
            ...
            .subscribeBy(
                onNext = {
                    ...
                    val list:List<Message> = messageQueue.filter{
                ...
                onComplete = {
                    ...
                    val list:List<Message> = messageQueue.sortedBy {it.timestamp}
                    messageQueue.clear()
                    list.forEach {
                        messageQueue.add(it)
                    }
                    ...
                    // acest lucru
                    val finishedMessagesMessage = Message.create("[MessageProcesor]",
    ...
    private fun sendProcessedMessages() {
        try {
            ...
            Observable.fromIterable(messageQueue).subscribeBy(
                ...
                onComplete = {
                    val noMoreMessages = Message.create("[MessageProcesor]",
