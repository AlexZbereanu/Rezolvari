    ...
    def search(self):
        ...
        if not search_string:
            ...
            if self.author_rb.isChecked():
                if self.json_rb.isChecked():
                    request = 'find:authorJson={}'.format(search_string)
                elif self.html_rb.isChecked():
                    request = 'find:authorHTML={}'.format(search_string)
                elif self.xml_rb.isChecked():
                    request = 'find:authorXML={}'.format(search_string)
                else:
                    request = 'find:authorRaw={}'.format(search_string)
            elif self.title_rb.isChecked():
                if self.json_rb.isChecked():
                    request = 'find:titleJson={}'.format(search_string)
                elif self.html_rb.isChecked():
                    request = 'find:titleHTML={}'.format(search_string)
                elif self.xml_rb.isChecked():
                    request = 'find:titleXML={}'.format(search_string)
                else:
                    request = 'find:titleRaw={}'.format(search_string)
            else:
                if self.json_rb.isChecked():
                    request = 'find:publisherJson={}'.format(search_string)
                elif self.html_rb.isChecked():
                    request = 'find:publisherHTML={}'.format(search_string)
                elif self.xml_rb.isChecked():
                    request = 'find:publisherXML={}'.format(search_string)
                else:
                    request = 'find:publisherRaw={}'.format(search_string)
